                    ...
                    <div className="col-span-2">
                        <div className="mb-6">
                            ...
                            <div className="mt-4 card-actions">
                                <a href={html_url} target='_blank' rel='noreferrer' className='btn btn-outlined'>Visit Github Profile</a>
                            </div>
                        </div>
                        <div className="w-full rounded-lg shadow-md bg-base-100 stats">
                            ...
                            {blog && (
                                <div className="stat">
                                    ...
                                    <div className="text-lg stat-value">
                                        <a href={`https://${blog}`} target='_blank' rel='norefferrer'>{blog}</a>
                                    </div>
                                </div>
                            )}
                            {twitter_username && (
                                <div className="stat">
                                    ...
                                    <div className="text-lg stat-value">
                                        <a href={`https://twitter.com/${twitter_username}`} target='_blank' rel='norefferrer'>{twitter_username}</a>
                                    </div>
                                </div>
                            )}
                        </div>
